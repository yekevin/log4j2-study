...
public class CustomFilterTest {
    ...
    static {
        System.setProperty("log4j.configurationFile", "extentions/log4j2_customFilter.xml");
    }
    ...
    public static void main(String[] args) {
        CustomFilterTest customFilterTest = new CustomFilterTest();
        customFilterTest.printLog();
    }

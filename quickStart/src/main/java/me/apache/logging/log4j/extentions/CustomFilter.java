package me.apache.logging.log4j.extentions;
...
public class CustomFilter extends AbstractFilter {
    ...
    public static CustomFilter createFilter(
        ...
        return new CustomFilter(key, map, level, onMatch, onMismatch);
    }
    ...
    private CustomFilter(final String key, final Map<String, Level> pairs, final Level defaultLevel,
    ...
    public boolean equals(final Object obj) {
        ...
        final CustomFilter other = (CustomFilter) obj;
    ...
    private Result filter(final Level level, final ReadOnlyStringMap contextMap) {
        ...
        if (value != null) {
            // TODO replace levelMap to dataBase search
